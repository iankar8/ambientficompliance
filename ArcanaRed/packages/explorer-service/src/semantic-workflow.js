...
exports.WORKFLOW_INTENTS = exports.SemanticWorkflowBuilder = void 0;
/**
 * Generates intelligent, goal-oriented prompts for the agent
 */
class SemanticWorkflowBuilder {
    selectorStrategy;
    constructor(selectorStrategy = {
...
exports.SemanticWorkflowBuilder = SemanticWorkflowBuilder;
/**
 * Common workflow intent templates
 */
exports.WORKFLOW_INTENTS = {
    zellePayment: (baseUrl, credentials) => ({
