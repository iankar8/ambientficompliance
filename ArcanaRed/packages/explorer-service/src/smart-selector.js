...
exports.COMMON_SELECTOR_PATTERNS = exports.SMART_NAVIGATION_SYSTEM_PROMPT = exports.SMART_DISCOVERY_TOOLS = void 0;
exports.generateSelectorHints = generateSelectorHints;
/**
 ...
 */
exports.SMART_NAVIGATION_SYSTEM_PROMPT = `You are ArcanaRed Explorer, an intelligent workflow automation agent.
...
exports.COMMON_SELECTOR_PATTERNS = [
    {
        intent: 'login_button',
        priority: [
 ...
 */
function generateSelectorHints(intents) {
    const hints = ['## Selector Discovery Hints\n'];
    intents.forEach(intent => {
        const pattern = exports.COMMON_SELECTOR_PATTERNS.find(p => p.intent === intent);
        if (pattern) {
            hints.push(`**${intent}**:`);
            pattern.priority
